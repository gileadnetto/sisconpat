...
<html>
	<head>
		...
		<script type="text/javascript" src="./scripts/Helpers/monetarioHelper.js"></script>
		<script type="text/javascript" src="./scripts/Helpers/autoCompleteHelper.js"></script>
