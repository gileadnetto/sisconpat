...
//PRODUTO DAO
define('BUSCA_PATRIMONIO' 			      , 		LOCALHOST2.'api/patrimonio/buscaAll?patrimonio=');
define('LISTAR_PATRIMONIO' 			  , 		LOCALHOST2.'api/patrimonio/listar');
define('BUSCA_LOCAL_PATRIMONIO'            , 		LOCALHOST2.'api/patrimonio/buscarLocal?local=');
define('BUSCA_TOMB_PATRIMONIO'		        , 		LOCALHOST2.'api/patrimonio/buscarTomb?tombamento=');
define('INSERIR_PATRIMONIO'		        , 		LOCALHOST2.'api/patrimonio/adicionar');
define('EXCLUIR_ATIVO_PATRIMONIO'          ,		LOCALHOST2.'api/patrimonio/deletarAtivo?tombamento=');
define('ATUALIZAR_PATRIMONIO' 		        ,		LOCALHOST2.'api/patrimonio/atualizar');
define('ATUALIZAR_LOC_PATRIMONIO'          ,		LOCALHOST2.'api/patrimonio/atualizarLocalidade');//conferir dps ele é usado na transferencia
